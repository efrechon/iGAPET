...
<div ></div><form id="SendBox" action="SaveFloor.php" method="post"><input id="SecretArray" type="hidden" name="Save" value="saveToForm()"><input type="button" onclick="saveToForm()"><input type="submit"></form>
</body>
