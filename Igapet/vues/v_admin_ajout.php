...
<div id="full">
    <div class="composants">
        ...
        <table>
            ...
            while($a=$reqA->fetch()){
                ...
                echo '<td>0</td>';
                echo '<td><a href="index.php?pageAction=admini&modification=catalogue&supprimeC='.$a['ActuatorTypeID'].'">Supprimer</a></td></tr>';
                echo '</tr>';
            }
            ?>
        </table>
    ...
    <div class="newcomposants">
        ...
        <form method="post" action="index.php?pageAction=admini&modification=catalogue">
