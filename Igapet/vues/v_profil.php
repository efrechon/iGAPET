...
<form action="index.php?pageAction=profil&modifier=yes" method="post">
    ...
    <input type="text" name="firstName" value= <?php if (isset($_SESSION['prenom'])) echo $_SESSION['prenom']?>><br/><br/>
    <label for="firstName">Nom : </label>
    <input type="text" name="lastName" value= <?php if (isset($_SESSION['nom'])) echo $_SESSION['nom']?>><br/><br/>
